...
function islogin(callback) {
    ...
    $.get("http://127.0.0.1:8888/web/islogin", function(result) {
        //console.log(result)
        if (result != "-1") {
            //已经登录
            // console.log(result)
            ...
            $("#personPage").attr("href", "http://127.0.0.1:8888/personPage.html?name=" + result.username)
        } else {
            //没有登录
            if (callback) {
                callback(-1, result)
...
function getpost(url, page) {
    ...
    $.get(url + page, function(result) {
        ...
        result.forEach(function(item, index) {
            ...
            var article = [
                ...
                '<a  target="_blank" href="http://127.0.0.1:8888/personPage.html?name=', item.author, , '">',
                ...
                '<div class="title">',
                '<p><a href="http://127.0.0.1:8888/detailPage.html?postid=',
    ...
    $(".post-wrap").on("click", ".delPost", function() {
        var url = "http://127.0.0.1:8888/post/delPost?postid=";
...
function getUser(name, callback) {
    $.get("http://127.0.0.1:8888/user/findUser?name=" + name, callback);
}
...
$(function() {
    ...
    $(".iknow").children().click(function() {
            if ($(this).html() == "取消") {
                ...
                $.get("http://127.0.0.1:8888/post/showUserNewComment", function(result) {
    ...
    $("#submitComment").on("click", function() {
        ...
        $.get("http://127.0.0.1:8888/post/setComment", {
            postid: postid,
    ...
    function createNewComment(result) {
        ...
        result.forEach(function(item, index) {
            ...
            var comment = $(
                ...
                '<a href="http://127.0.0.1:8888/detailPage.html?postid=' + item.postId + '">详情</a>' +
                '</div></div></div>' +
                '<div class="post-part">' +
